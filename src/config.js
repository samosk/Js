const production = {
	basePath: '/Js',  // Base path for GitHub Pages: https://samosk.github.io/Js/
	assetPath: '/Js'  // Assets are also in the /Js directory
  };
  
  const development = {
	basePath: '',     // No base path needed in local development
	assetPath: 'Js'   // Local assets in the Js directory
  };
